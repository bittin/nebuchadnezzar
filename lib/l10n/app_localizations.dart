...
abstract class AppLocalizations {
  ...
  /// No description provided for @nebuchadnezzar.
  ///
  /// In en, this message translates to:
  /// **'Nebuchadnezzar'**
  String get nebuchadnezzar;
  ...
  /// No description provided for @newMessageInNebuchadnezzar.
  ///
  /// In en, this message translates to:
  /// **'💬 New message in Nebuchadnezzar'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Allows Nebuchadnezzar to use the native android dialer app.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Microphone, camera and other Nebuchadnezzar permissions'**
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      <String>['de', 'en', 'sv', 'zh'].contains(locale.languageCode);
